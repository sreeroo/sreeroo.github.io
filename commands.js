...
experience = [
  ...
  "<br>",
  "- Sreeroop is currently working as a Dual Student at Rohde & Schwarz GmbH & Co. KG, Munich, Germany. Few projects he worked on are - ",
  " -> A Big Data project with ETL pipelines that is based on the microservices architecture. He worked on the ETL Pipelines in Python, .NET Core Backend, Frontend that uses Angular, and databases such as PostgreSQL and MongoDB.",
  " -> API development using REST, GraphQL and OData in Python and C#.",
  " -> He has also worked on test automation projects using Python and Selenium and internal tools development using C#, Python and Docker for the company.",
  "<br>",
